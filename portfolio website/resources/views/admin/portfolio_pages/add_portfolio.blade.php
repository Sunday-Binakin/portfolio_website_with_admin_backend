                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('store.portfolio') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" cols="7" rows="6" id="portfolio_title"
                                        name="portfolio_title" type="text"></textarea>
                            ...
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Portfolio
                                    Description</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="elm1" name="portfolio_description" type="text"
                                        ></textarea>
                                </div>
                            </div> <!-- end row -->
