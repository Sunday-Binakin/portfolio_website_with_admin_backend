            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" id="categoryBlogForm" action="{{ route('store.blog.category') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Blog Category Name</label>
                                <div class="col-sm-10">
                                    <input class="form-control" id="blog_category" name="blog_category" type="text">
{{-- javascript validation waya --}}

{{-- end javascript validation waya --}}
