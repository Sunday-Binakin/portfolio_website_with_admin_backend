                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('update.blog') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" aria-label="Default select example">
                                        ...
                                        <option
                                            value="{{ $category->id }}{{ $category->id == $blog_edit->blog_category_id? 'selected':'' }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="blog_tag" value="home,sweet" type="text"
                                        data-role="tagsinput" value="{{ $blog_edit->blog_tag }}">
                                </div>
                            </div> <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="elm1" name="blog_description"
                                        type="text">{{$blog_edit->blog_description  }}</textarea>
                                </div>
                            </div> <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="showImage" class="rounded avatar-lg"
                                        src="{{asset($blog_edit->blog_image) }}" alt="">
                                </div>
                            </div> <!-- end row -->
